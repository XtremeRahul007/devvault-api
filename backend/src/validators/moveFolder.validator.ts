import type { MoveFolderInput } from "../@types/folder.types.js";
import { AppError } from "../core/errors/AppError.js";

const whiteListed = ["id"] as const;

export function moveFolderValidator(reqBody: unknown): MoveFolderInput {
    ...
    const validatedID = validateOptionalString(body.id, "id");

    return removeUndefined({ folderId: validatedID });
}
